...
`;function J(e,r){let t=l``;return r&&(t=l`
  ...
  align-items: center;
  gap: 8px;
`,Ie=e=>{const{title:r,contentLabel:t,isRequired:s=!1,defaultValue:n,placeholders:a=[],styles:u=[],name:y,tips:c,controlledType:d,control:i,error:b,options:w=[],rules:E=[],tipsStyle:T,allowClear:U=!1,forceEqualWidth:D,labelStyle:W,onValueChange:_}=e,j=(Array.isArray(d)?d:[d]).filter(O=>O.trim()&&O!=="none"),ee=Array.isArray(y)?y:[y],te=Array.isArray(n)?n:[n],re=j.includes("textarea"),ne=N.useCallback((O,x,S,P,C,v={})=>{switch(O){case"input":return o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(ue,{w:"100%",...v,onBlur:h,onChange:p,value:f,error:b,colorScheme:"techPurple",placeholder:P}),name:x});case"checkbox":return B(I,{children:[o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(ce,{...v,onBlur:h,onChange:V=>{p(V),_==null||_(V)},checked:f,colorScheme:"techPurple",placeholder:P}),name:x}),o("span",{css:G,children:t})]});case"select":return o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(le,{value:f,onBlur:h,allowClear:U,onChange:V=>{_==null||_(V),p(V)},colorScheme:"techPurple",options:w}),name:x});case"switch":return B(I,{children:[o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(ae,{checked:f,colorScheme:"techPurple",onChange:V=>{p(V),_==null||_(V)},onBlur:h,...v}),name:x}),o("span",{css:G,children:t})]});case"number":return o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(oe,{onBlur:h,onChange:p,value:f,colorScheme:"techPurple",w:"100%",placeholder:P,...v}),name:x});case"password":return o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(ie,{autoComplete:"new-password",colorScheme:"techPurple",w:"100%",onBlur:h,onChange:p,value:f,placeholder:P,...v}),name:x});case"radio":return o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(H,{colorScheme:"techPurple",w:"100%",type:"radio",onBlur:h,onChange:p,value:f,placeholder:P,options:w,...v}),name:x});case"radio-group":return o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(H,{colorScheme:"gray",w:"100%",type:"button",onBlur:h,onChange:p,value:f,placeholder:P,forceEqualWidth:D,options:w,...v}),name:x});case"textarea":return o(A,{control:i,defaultValue:S,rules:C,render:({field:{value:f,onChange:p,onBlur:h}})=>o(se,{w:"100%",h:"100%",pb:"16px",minH:"240px",colorScheme:"techPurple",onBlur:h,onChange:p,value:f,autoSize:!1,placeholder:P,...v}),name:x})}},[U,t,i,b,D,_,w]);return B(I,{children:[!!j.length&&B("div",{css:Te(re),children:[B("div",{css:W||Ee,children:[s&&o("span",{css:J(F("red","03")),children:"*"}),o("span",{css:J(F("grayBlue","02")),children:r})]}),o("div",{css:je,children:j.map((O,x)=>o(N.Fragment,{children:ne(O,ee[x],te[x],a[x],E[x],u[x])},x))})]}),c&&o("div",{css:T||Be,children:c})]})};Ie.displayName="ControlledElement";const ze=l`
  width: 100%;
  overflow: auto;
  max-height: 656px;
`;function Ue(e,r){let t=l``;return r&&(t=l`
      margin-left: 4px;
    `),l`
    font-size: 14px;
    color: ${e};
...
`,Ke=l`
  ...
  flex-direction: row;
  padding-left: 24px;
`;export{Ie as C,Me as a,Ue as b,ze as c,A as d,Ne as e,De as f,Ke as g,je as h,We as l,He as o,qe as p,z as u};
//# sourceMappingURL=style-3f22391e.js.map
