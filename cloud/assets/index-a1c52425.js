import{h as b,I as Ee,n as g,j as p,al as st,C as ct,B as q,y as lt,F as Pe,g as k,f as Z,am as ht,a6 as Y,an as pt}from"./@illa-design-764f0835.js";import{L as dt}from"./index-f9c3a6b2.js";import{ab as ut,a0 as ze,ac as mt,F as $,M as gt,u as le,g as he,A as Me,a9 as ft,K as vt,ad as wt,O as yt}from"./index-a570ca0c.js";import{g as xt,b as z,r as m}from"./react-bc846394.js";import{C as De,u as Ct}from"./index.esm-11ba4214.js";import{T as Ae,a as bt}from"./index-2ce4c85a.js";import{a as d}from"./@emotion-09d14760.js";import{I as F}from"./interface-8df5fe4c.js";import{S as St}from"./index-500f1908.js";import{H as _t}from"./index-c329647b.js";const Rt=(r,o)=>{const e=r.split("?")[0];return new Promise(async(t,n)=>{try{await ut.put(r,o,{headers:{"Content-Type":"multipart/form-data","x-amz-acl":"public-read"}}),t(e)}catch(i){n(i)}})},Et=async r=>{const o=mt();try{return(await ze({url:`/users/avatar/uploadAddress/fileName/${o}.${r}`,method:"GET"})).data}catch(e){throw e}},Pt=r=>new Promise(async(o,e)=>{try{const t=r.type.split("/")[1],n=await Et(t);if(n){const i=await Rt(n.uploadAddress,r);o(i)}}catch(t){e(t)}}),zt=async r=>{try{return await ze({url:"/users/avatar",method:"PATCH",data:{avatar:r}})}catch(o){throw o}};/*! *****************************************************************************
...
//# sourceMappingURL=index-a1c52425.js.map
