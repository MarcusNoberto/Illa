import{ae as lt,a3 as Me,af as ht,F as U,M as pt,u as de,g as ue,J as p,K as v,A as De,ac as dt,S as ut,N as mt,ag as gt,Q as ft}from"./index-31e67bad.js";import{L as vt}from"./index-d109cc65.js";import{f as g,l as S,N as Ae,q as Z,k as P,ao as wt,C as yt,B as Q,E as xt,F as Ct,g as B,h as j,ap as bt,a9 as K,aq as St}from"./@illa-design-5a8ac2e4.js";import{g as _t,b as D,r as u}from"./react-bc846394.js";import{C as Le,u as Rt}from"./index.esm-11ba4214.js";import{T as Te,a as Et}from"./index-ce0477c6.js";import{I as $}from"./interface-8df5fe4c.js";import{S as Pt}from"./index-8bfdf942.js";import{e as f}from"./@emotion-28b7fe46.js";import{H as zt}from"./index-ff846a29.js";const Mt=(r,o)=>{const e=r.split("?")[0];return new Promise(async(t,n)=>{try{await lt.put(r,o,{headers:{"Content-Type":"multipart/form-data","x-amz-acl":"public-read"}}),t(e)}catch(i){n(i)}})},Dt=async r=>{const o=ht();try{return(await Me({url:`/users/avatar/uploadAddress/fileName/${o}.${r}`,method:"GET"})).data}catch(e){throw e}},At=r=>new Promise(async(o,e)=>{try{const t=r.type.split("/")[1],n=await Dt(t);if(n){const i=await Mt(n.uploadAddress,r);o(i)}}catch(t){e(t)}}),Lt=async r=>{try{return await Me({url:"/users/avatar",method:"PATCH",data:{avatar:r}})}catch(o){throw o}};/*! *****************************************************************************
...
//# sourceMappingURL=index-d948f029.js.map
