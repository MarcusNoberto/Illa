...
`;n`
  ...
  top: 72px;
  right: 113px;
`;const j=({item:e})=>{const i=E(),l=o=>{i(o)};return s("div",{css:B,onClick:()=>e.onClick?e.onClick():l(e.path),children:[t("div",{children:e.label}),t(C,{css:$})]})},u=({itemList:e})=>t("div",{children:e.map(i=>i.hidden?null:t(j,{item:i},i.path))}),m=()=>{const{t:e}=w(),i=f(M),l=!R(i),o=[{path:"/setting/account",label:e("profile.setting.personal_info")},{path:"/setting/password",label:e("profile.setting.password.title")},{path:"/setting/language",label:e("profile.setting.language")},{path:"",label:e("profile.setting.logout"),onClick:v}],a=[{path:`/setting/${i==null?void 0:i.identifier}/members`,label:e("team_setting.left_panel.member"),hidden:l}];return s(c,{children:[t("div",{css:L,children:e("profile.setting.title")}),s("div",{css:h,children:[t(y,{}),t("span",{children:e("profile.setting.group.account")})]}),t(u,{itemList:o}),l&&s(c,{children:[t("div",{css:N}),i&&t(c,{children:s("div",{css:h,children:[t(k,{}),t("span",{children:e("profile.setting.group.team")})]})}),t(u,{itemList:a})]})]})};m.displayName="MobileEntrance";const U=()=>t(x,{desktopPage:t(S,{to:"/setting/account",replace:!0}),mobilePage:t(b,{withoutPadding:!0,children:t(m,{})})});export{U as default};
//# sourceMappingURL=index-a8806f7d.js.map
