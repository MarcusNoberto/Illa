...
`;function wr(e){return r`
  ...
  justify-content: center;
  height: 12px;
`,$t=e=>{var v;const{onClickItem:t,withoutTips:n,value:o,showOwner:i,currentUserRole:a,isSelf:s,inline:p,excludeUserRole:h}=e,[d,f]=c.useState(!1),g=!s&&te(o,a,!0),{t:u}=re(),_=c.useMemo(()=>[{role:U.OWNER,tips:u("user_management.role.tips.owner"),name:u("user_management.role.owner")},{role:U.ADMIN,tips:u("user_management.role.tips.admin"),name:u("user_management.role.admin")},{role:U.EDITOR,tips:u("user_management.role.tips.editor"),name:u("user_management.role.editor")},{role:U.VIEWER,tips:u("user_management.role.tips.viewer"),name:u("user_management.role.viewer")}],[u]),x=c.useMemo(()=>(i?_:_.filter(w=>w.role!==U.OWNER)).filter(w=>!(h!=null&&h.includes(w.role))&&te(w.role,a)),[a,h,i,_]);return l(je,{disabled:!g||x.length<=1,onVisibleChange:y=>{f(y)},dropList:l(We,{onClickItem:y=>{t==null||t(y)},children:x.map(y=>l(de,{value:y.role,title:C("div",{css:gr,children:[l("div",{children:y.name}),!n&&l(Dn,{zIndex:1e3,children:l(at,{trigger:"hover",position:"top",content:y.tips,children:l("div",{css:mr,children:l(st,{})})})}),o===y.role&&l("div",{css:xr,children:l(Bi,{})})]})},y.role))}),position:"bottom-end",trigger:"click",children:C("div",{css:yr,children:[l("div",{css:wr(p),children:(v=_.find(y=>y.role===o))==null?void 0:v.name}),g&&x.length>1&&l("div",{css:br,children:d?l(Mn,{}):l(Bn,{})})]})})};var lt=(e=>(e.STORAGE="storage",e.TOKEN="token",e.TRAFFIC="traffic",e))(lt||{}),Dt=(e=>(e.CREATE="create",e.TRANSFER_OWNER="transferOwner",e))(Dt||{});X.FREE+"",X.MONTHLY+"",X.YEARLY+"",X.LIFETIME+"";X.FREE+"",X.MONTHLY+"",X.YEARLY+"",X.LIFETIME+"";X.FREE+"",X.MONTHLY+"",X.YEARLY+"",X.LIFETIME+"";X.FREE+"",X.MONTHLY+"",X.YEARLY+"",X.LIFETIME+"";const ce={listener:[],modal:null};function _r(){return{getModal:()=>ce.modal,setModal:e=>{ce.modal=e,ce.listener.forEach(t=>{t.onStoreChange()})},subscribe:e=>{const t={listenerId:Pn(),onStoreChange:e};return ce.listener.push(t),t.onStoreChange(),t},unSubscribe:e=>{ce.listener.splice(ce.listener.findIndex(t=>t.listenerId===e),1)},update:e=>{ce.modal=e,ce.listener.forEach(t=>{t.onStoreChange()})},remove:()=>{ce.modal=null,ce.listener.forEach(e=>{e.onStoreChange()})}}}const Cr=_r(),vr=e=>(e.id||(e.id=Pn()),e.visible||(e.visible=!0),Cr.setModal(e),e.id),Er=e=>vr(e);function Jt(){return Er}r`
  display: flex;
 ...
 */var Pe=c;function el(e,t){return e===t&&(e!==0||1/e===1/t)||e!==e&&t!==t}var tl=typeof Object.is=="function"?Object.is:el,nl=Pe.useState,il=Pe.useEffect,rl=Pe.useLayoutEffect,ol=Pe.useDebugValue;function al(e,t){var n=t(),o=nl({inst:{value:n,getSnapshot:t}}),i=o[0].inst,a=o[1];return rl(function(){i.value=n,i.getSnapshot=t,vt(i)&&a({inst:i})},[e,n,t]),il(function(){return vt(i)&&a({inst:i}),e(function(){vt(i)&&a({inst:i})})},[e]),ol(n),n}function vt(e){var t=e.getSnapshot;e=e.value;try{var n=t();return!tl(e,n)}catch{return!0}}function sl(e,t){return t()}var ll=typeof window>"u"||typeof window.document>"u"||typeof window.document.createElement>"u"?sl:al;Ei.useSyncExternalStore=Pe.useSyncExternalStore!==void 0?Pe.useSyncExternalStore:ll;vi.exports=Ei;var cl=vi.exports;const be=()=>{},ee=be(),Et=Object,B=e=>e===ee,me=e=>typeof e=="function",_e=(e,t)=>({...e,...t}),dl=e=>me(e.then),rt=new WeakMap;let pl=0;const Ge=e=>{const t=typeof e,n=e&&e.constructor,o=n==Date;let i,a;if(Et(e)===e&&!o&&n!=RegExp){if(i=rt.get(e),i)return i;if(i=++pl+"~",rt.set(e,i),n==Array){for(i="@",a=0;a<e.length;a++)i+=Ge(e[a])+",";rt.set(e,i)}if(n==Et){i="#";const s=Et.keys(e).sort();for(;!B(a=s.pop());)B(e[a])||(i+=a+":"+Ge(e[a])+",");rt.set(e,i)}}else i=o?e.toJSON():t=="symbol"?e.toString():t=="string"?JSON.stringify(e):""+e;return i},ge=new WeakMap,It={},ot={},nn="undefined",ht=typeof window!=nn,Ft=typeof document!=nn,ul=()=>ht&&typeof window.requestAnimationFrame!=nn,Ii=(e,t)=>{const n=ge.get(e);return[()=>!B(t)&&e.get(t)||It,o=>{if(!B(t)){const i=e.get(t);t in ot||(ot[t]=i),n[5](t,_e(i,o),i||It)}},n[6],()=>!B(t)&&t in ot?ot[t]:!B(t)&&e.get(t)||It]};let Wt=!0;const hl=()=>Wt,[jt,Ht]=ht&&window.addEventListener?[window.addEventListener.bind(window),window.removeEventListener.bind(window)]:[be,be],fl=()=>{const e=Ft&&document.visibilityState;return B(e)||e!=="hidden"},gl=e=>(Ft&&document.addEventListener("visibilitychange",e),jt("focus",e),()=>{Ft&&document.removeEventListener("visibilitychange",e),Ht("focus",e)}),ml=e=>{const t=()=>{Wt=!0,e()},n=()=>{Wt=!1};return jt("online",t),jt("offline",n),()=>{Ht("online",t),Ht("offline",n)}},xl={isOnline:hl,isVisible:fl},yl={initFocus:gl,initReconnect:ml},An=!Ze.useId,qe=!ht||"Deno"in window,wl=e=>ul()?window.requestAnimationFrame(e):setTimeout(e,1),St=qe?c.useEffect:c.useLayoutEffect,Rt=typeof navigator<"u"&&navigator.connection,kn=!qe&&Rt&&(["slow-2g","2g"].includes(Rt.effectiveType)||Rt.saveData),rn=e=>{if(me(e))try{e=e()}catch{e=""}const t=e;return e=typeof e=="string"?e:(Array.isArray(e)?e.length:e)?Ge(e):"",[e,t]};let bl=0;const Kt=()=>++bl,Si=0,Ri=1,Li=2,_l=3;var Ue={__proto__:null,ERROR_REVALIDATE_EVENT:_l,FOCUS_EVENT:Si,MUTATE_EVENT:Li,RECONNECT_EVENT:Ri};async function Ai(...e){const[t,n,o,i]=e,a=_e({populateCache:!0,throwOnError:!0},typeof i=="boolean"?{revalidate:i}:i||{});let s=a.populateCache;const p=a.rollbackOnError;let h=a.optimisticData;const d=a.revalidate!==!1,f=_=>typeof p=="function"?p(_):p!==!1,g=a.throwOnError;if(me(n)){const _=n,x=[],v=t.keys();for(const y of v)!/^\$(inf|sub)\$/.test(y)&&_(t.get(y)._k)&&x.push(y);return Promise.all(x.map(u))}return u(n);async function u(_){const[x]=rn(_);if(!x)return;const[v,y]=Ii(t,x),[w,I,T,E]=ge.get(t),F=()=>{const M=w[x];return d&&(delete T[x],delete E[x],M&&M[0])?M[0](Li).then(()=>v().data):v().data};if(e.length<3)return F();let L=o,A;const b=Kt();I[x]=[b,0];const R=!B(h),$=v(),O=$.data,G=$._c,W=B(G)?O:G;if(R&&(h=me(h)?h(W,O):h,y({data:h,_c:W})),me(L))try{L=L(W)}catch(M){A=M}if(L&&dl(L))if(L=await L.catch(M=>{A=M}),b!==I[x][0]){if(A)throw A;return L}else A&&R&&f(A)&&(s=!0,y({data:W,_c:ee}));if(s&&!A)if(me(s)){const M=s(L,W);y({data:M,error:ee,_c:ee})}else y({data:L,error:ee,_c:ee});if(I[x][1]=Kt(),Promise.resolve(F()).then(()=>{y({_c:ee})}),A){if(g)throw A;return}return L}}const Tn=(e,t)=>{for(const n in e)e[n][0]&&e[n][0](t)},Cl=(e,t)=>{if(!ge.has(e)){const n=_e(yl,t),o={},i=Ai.bind(ee,e);let a=be;const s={},p=(f,g)=>{const u=s[f]||[];return s[f]=u,u.push(g),()=>u.splice(u.indexOf(g),1)},h=(f,g,u)=>{e.set(f,g);const _=s[f];if(_)for(const x of _)x(g,u)},d=()=>{if(!ge.has(e)&&(ge.set(e,[o,{},{},{},i,h,p]),!qe)){const f=n.initFocus(setTimeout.bind(ee,Tn.bind(ee,o,Si))),g=n.initReconnect(setTimeout.bind(ee,Tn.bind(ee,o,Ri)));a=()=>{f&&f(),g&&g(),ge.delete(e)}}};return d(),[e,i,d,a]}return[e,ge.get(e)[4]]},vl=(e,t,n,o,i)=>{const a=n.errorRetryCount,s=i.retryCount,p=~~((Math.random()+.5)*(1<<(s<8?s:8)))*n.errorRetryInterval;!B(a)&&s>a||setTimeout(o,p,i)},El=(e,t)=>Ge(e)==Ge(t),[ki,Il]=Cl(new Map),Sl=_e({onLoadingSlow:be,onSuccess:be,onError:be,onErrorRetry:vl,onDiscarded:be,revalidateOnFocus:!0,revalidateOnReconnect:!0,revalidateIfStale:!0,shouldRetryOnError:!0,errorRetryInterval:kn?1e4:5e3,focusThrottleInterval:5*1e3,dedupingInterval:2*1e3,loadingTimeout:kn?5e3:3e3,compare:El,isPaused:()=>!1,cache:ki,mutate:Il,fallback:{}},xl),Rl=(e,t)=>{const n=_e(e,t);if(t){const{use:o,fallback:i}=e,{use:a,fallback:s}=t;o&&a&&(n.use=o.concat(a)),i&&s&&(n.fallback=_e(i,s))}return n},Ll=c.createContext({}),Al="$inf$",Ti=ht&&window.__SWR_DEVTOOLS_USE__,kl=Ti?window.__SWR_DEVTOOLS_USE__:[],Tl=()=>{Ti&&(window.__SWR_DEVTOOLS_REACT__=Ze)},$l=e=>me(e[1])?[e[0],e[1],e[2]||{}]:[e[0],null,(e[1]===null?e[2]:e[1])||{}],Dl=()=>_e(Sl,c.useContext(Ll)),Ml=e=>(t,n,o)=>e(t,n&&((...a)=>{const[s]=rn(t),[,,,p]=ge.get(ki);if(s.startsWith(Al))return n(...a);const h=p[s];return B(h)?n(...a):(delete p[s],h)}),o),Bl=kl.concat(Ml),Pl=e=>function(...n){const o=Dl(),[i,a,s]=$l(n),p=Rl(o,s);let h=e;const{use:d}=p,f=(d||[]).concat(Bl);for(let g=f.length;g--;)h=f[g](h);return h(i,a||p.fetcher||null,p)},Ol=(e,t,n)=>{const o=t[e]||(t[e]=[]);return o.push(n),()=>{const i=o.indexOf(n);i>=0&&(o[i]=o[o.length-1],o.pop())}};Tl();const $n=Ze.use||(e=>{if(e.status==="pending")throw e;if(e.status==="fulfilled")return e.value;throw e.status==="rejected"?e.reason:(e.status="pending",e.then(t=>{e.status="fulfilled",e.value=t},t=>{e.status="rejected",e.reason=t}),e)}),Lt={dedupe:!0},Nl=(e,t,n)=>{const{cache:o,compare:i,suspense:a,fallbackData:s,revalidateOnMount:p,revalidateIfStale:h,refreshInterval:d,refreshWhenHidden:f,refreshWhenOffline:g,keepPreviousData:u}=n,[_,x,v,y]=ge.get(o),[w,I]=rn(e),T=c.useRef(!1),E=c.useRef(!1),F=c.useRef(w),L=c.useRef(t),A=c.useRef(n),b=()=>A.current,R=()=>b().isVisible()&&b().isOnline(),[$,O,G,W]=Ii(o,w),M=c.useRef({}).current,J=B(s)?n.fallback[w]:s,se=(z,V)=>{for(const Z in M){const H=Z;if(H==="data"){if(!i(z[H],V[H])&&(!B(z[H])||!i(j,V[H])))return!1}else if(V[H]!==z[H])return!1}return!0},k=c.useMemo(()=>{const z=(()=>!w||!t?!1:B(p)?b().isPaused()||a?!1:B(h)?!0:h:p)(),V=Q=>{const ue=_e(Q);return delete ue._k,z?{isValidating:!0,isLoading:!0,...ue}:ue},Z=$(),H=W(),le=V(Z),Te=Z===H?le:V(H);let q=le;return[()=>{const Q=V($());return se(Q,q)?(q.data=Q.data,q.isLoading=Q.isLoading,q.isValidating=Q.isValidating,q.error=Q.error,q):(q=Q,Q)},()=>Te]},[o,w]),Y=cl.useSyncExternalStore(c.useCallback(z=>G(w,(V,Z)=>{se(Z,V)||z()}),[o,w]),k[0],k[1]),K=!T.current,ne=_[w]&&_[w].length>0,ye=Y.data,we=B(ye)?J:ye,Ae=Y.error,Qe=c.useRef(we),j=u?B(ye)?Qe.current:ye:we,ke=(()=>ne&&!B(Ae)?!1:K&&!B(p)?p:b().isPaused()?!1:a?B(we)?!1:h:B(we)||h)(),ft=!!(w&&t&&K&&ke),$i=B(Y.isValidating)?ft:Y.isValidating,Di=B(Y.isLoading)?ft:Y.isLoading,Ve=c.useCallback(async z=>{const V=L.current;if(!w||!V||E.current||b().isPaused())return!1;let Z,H,le=!0;const Te=z||{},q=!v[w]||!Te.dedupe,Q=()=>An?!E.current&&w===F.current&&T.current:w===F.current,ue={isValidating:!1,isLoading:!1},an=()=>{O(ue)},sn=()=>{const oe=v[w];oe&&oe[1]===H&&delete v[w]},ln={isValidating:!0};B($().data)&&(ln.isLoading=!0);try{if(q&&(O(ln),n.loadingTimeout&&B($().data)&&setTimeout(()=>{le&&Q()&&b().onLoadingSlow(w,n)},n.loadingTimeout),v[w]=[V(I),Kt()]),[Z,H]=v[w],Z=await Z,q&&setTimeout(sn,n.dedupingInterval),!v[w]||v[w][1]!==H)return q&&Q()&&b().onDiscarded(w),!1;ue.error=ee;const oe=x[w];if(!B(oe)&&(H<=oe[0]||H<=oe[1]||oe[1]===0))return an(),q&&Q()&&b().onDiscarded(w),!1;const he=$().data;ue.data=i(he,Z)?he:Z,q&&Q()&&b().onSuccess(Z,w,n)}catch(oe){sn();const he=b(),{shouldRetryOnError:gt}=he;he.isPaused()||(ue.error=oe,q&&Q()&&(he.onError(oe,w,he),(gt===!0||me(gt)&&gt(oe))&&R()&&he.onErrorRetry(oe,w,he,Mi=>{const mt=_[w];mt&&mt[0]&&mt[0](Ue.ERROR_REVALIDATE_EVENT,Mi)},{retryCount:(Te.retryCount||0)+1,dedupe:!0})))}return le=!1,an(),!0},[w,o]),on=c.useCallback((...z)=>Ai(o,F.current,...z),[]);if(St(()=>{L.current=t,A.current=n,B(ye)||(Qe.current=ye)}),St(()=>{if(!w)return;const z=Ve.bind(ee,Lt);let V=0;const H=Ol(w,_,(le,Te={})=>{if(le==Ue.FOCUS_EVENT){const q=Date.now();b().revalidateOnFocus&&q>V&&R()&&(V=q+b().focusThrottleInterval,z())}else if(le==Ue.RECONNECT_EVENT)b().revalidateOnReconnect&&R()&&z();else{if(le==Ue.MUTATE_EVENT)return Ve();if(le==Ue.ERROR_REVALIDATE_EVENT)return Ve(Te)}});return E.current=!1,F.current=w,T.current=!0,O({_k:I}),ke&&(B(we)||qe?z():wl(z)),()=>{E.current=!0,H()}},[w]),St(()=>{let z;function V(){const H=me(d)?d($().data):d;H&&z!==-1&&(z=setTimeout(Z,H))}function Z(){!$().error&&(f||b().isVisible())&&(g||b().isOnline())?Ve(Lt).then(V):V()}return V(),()=>{z&&(clearTimeout(z),z=-1)}},[d,f,g,w]),c.useDebugValue(j),a&&B(we)&&w){if(!An&&qe)throw new Error("Fallback data is required when using suspense in SSR.");L.current=t,A.current=n,E.current=!1;const z=y[w];if(!B(z)){const V=on(z);$n(V)}if(B(Ae)){const V=Ve(Lt);B(j)||(V.status="fulfilled",V.value=!0),$n(V)}else throw Ae}return{mutate:on,get data(){return M.data=!0,j},get error(){return M.error=!0,Ae},get isValidating(){return M.isValidating=!0,$i},get isLoading(){return M.isLoading=!0,Di}}},Ec=Pl(Nl),Ic=()=>{const[e,t]=c.useState(!1);return[e,o=>{o.target.scrollTop>=24?t(!0):t(!1)}]};export{ei as A,_c as D,Cc as M,ss as P,hr as S,hc as T,pc as a,ur as b,ic as c,cc as d,ac as e,sc as f,lc as g,rc as h,dc as i,vc as j,Ic as k,uc as l,nc as m,Il as n,gc as o,mc as p,tc as q,fc as r,xc as s,oc as t,Ec as u,yc as v,wc as w,bc as x};
//# sourceMappingURL=hook-a5e6f811.js.map
