...
`,mn=e=>{const{excludeUserRole:r,defaultAllowInviteLink:t,defaultInviteUserRole:a,onInviteLinkStateChange:n,teamID:i,currentUserRole:s,onCopyInviteLink:f,defaultBalance:p,redirectURL:o}=e,[w,_]=fe(a,{defaultValue:a}),[x,v]=fe(t,{defaultValue:t}),A=be(),P=ze(),{t:m}=re(),[U,E]=g.useState(""),[$,O]=g.useState(!1),[D,H]=g.useState(!1);g.useEffect(()=>{if(!x)return;O(!0);let I=new AbortController;return(async()=>{try{const R=await on(i,w,o,window.customDomain,I.signal);E(R.data.inviteLink)}catch{A.error({content:m("user_management.modal.link.fail")})}finally{O(!1)}})(),()=>{I.abort()}},[s,i,x,w,A,m,o]);const ee=g.useCallback(async(I,V)=>{O(!0);try{const R=await cn(I,o,V,window.customDomain);E(R.data.inviteLink)}catch{A.error({content:m("user_management.modal.link.fail")})}finally{O(!1)}_(V)},[A,o,_,m]),B=g.useCallback(async I=>{H(!0);try{await un(I),v(!0),n==null||n(!0)}catch{A.error({content:m("user_management.modal.link.turn_on_fail")})}finally{H(!1)}},[A,n,v,m]),F=g.useCallback(async I=>{H(!0);try{await dn(I),v(!1),n==null||n(!1)}catch{A.error({content:m("user_management.modal.link.turn_off_fail")})}finally{H(!1)}},[A,n,v,m]);return c(We,{children:x?M("div",{css:ii,children:[M("div",{css:li,children:[c(gn,{}),c("div",{css:oi,children:c(Ce,{withoutTips:!0,excludeUserRole:r,currentUserRole:s,value:w,onClickItem:async I=>{Q(q.VIEWER,I,!1)&&p===0?P({modalType:"upgrade",from:"invite_by_link"}):await ee(i,I)}})})]}),M("div",{css:si,children:[c(de,{_css:et,colorScheme:"techPurple",fullWidth:!0,loading:$,disabled:D,onClick:()=>{const I=new URL(U);I.searchParams.set("redirectURL",o),f==null||f(I.href)},children:m("user_management.modal.link.copy")}),c(de,{_css:et,colorScheme:"grayBlue",variant:"text",fullWidth:!0,loading:D,disabled:$,onClick:()=>{F(i)},children:m("user_management.modal.link.turn_off")})]})]}):M("div",{css:ai,children:[c(ri,{}),c(de,{_css:et,colorScheme:"techPurple",fullWidth:!0,loading:D,disabled:$,onClick:()=>{B(i)},children:m("user_management.modal.link.turn_on")})]})})};mn.displayName="InviteLinkMobile";u`
  position: sticky;
  top: 0;
  padding-top: 12px;
...
`,ma=u`
  ...
  width: 24px;
  height: 24px;
`,En=e=>{const{title:r,shareUrl:t}=e,{t:a}=re();return M("div",{css:da,children:[c("div",{css:fa,children:a("user_management.modal.social_media.label")}),c("div",{css:ha,children:_n.map(n=>{const i=c("div",{css:ga,onClick:()=>{},children:c("div",{css:ma,children:n.icon})},n.platform);switch(n.platform){case ne.X:return c(Cn,{url:e.shareUrl,title:r,children:i},n.platform);case ne.REDDIT:return c(vn,{url:e.shareUrl,title:r,children:i},n.platform);case ne.LINKEDIN:return c(wn,{url:e.shareUrl,title:r,children:i},n.platform);case ne.HACKER_NEWS:return c("div",{onClick:()=>{window.open(`https://news.ycombinator.com/submitlink?u=${t}&t=${r}`,"_blank")},children:i},n.platform);case ne.FACEBOOK:return c(xn,{url:e.shareUrl,title:r,children:i},n.platform);case ne.WHATSAPP:return c(bn,{url:e.shareUrl,title:r,children:i},n.platform);default:return null}})})]})};En.displayName="ShareBlockMobile";const ya=u`
  width: 100%;
  display: flex;
  flex-direction: column;
...
`,va=u`
  ...
  align-items: center;
  gap: 8px;
`,In=e=>{const{title:r,onShare:t,agentID:a,onCopyAgentMarketLink:n}=e,{t:i}=re();return M("div",{css:ya,children:[c("div",{css:pa,children:c(gn,{})}),c("div",{css:va,children:c(de,{_css:xa,colorScheme:"techPurple",fullWidth:!0,onClick:()=>{n==null||n(Ue(a))},children:i("user_management.modal.link.copy")})}),c("div",{css:wa,children:c(En,{onShare:t,title:r,shareUrl:Ue(a)})})]})};In.displayName="AgentToMarketplaceMobile";const Ca=u`
  padding-top: 12px;
  width: 100%;
  flex: none;
  overflow-x: hidden;
...
//# sourceMappingURL=style-af69883e.js.map
