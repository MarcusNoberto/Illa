import{bf as y,be as c,w as $,bg as E,bh as B,bi as z,bj as p,bk as I,bl as P,e as U,b as D,bm as T,n as j,bn as k,bo as H,bp as L,D as W,bq as G,br as R,bs as w,bt as N,bu as M,bv as _,bw as F,bx as O,by as q,bz as V,bA as J,bB as K,bC as Q}from"./index-4dce6ee8.js";import{l as b,n as l,m as A}from"./@illa-design-1f43bb6c.js";import{u as X,r as S}from"./react-9b7e00e3.js";import{f as Y,u as Z}from"./layoutInfoListener-bd63c738.js";import{a}from"./@emotion-08a6282b.js";import{u as ee,m as te}from"./renderComponentCanvasContainer-2e4cd54a.js";const oe=(e,t,o,i,n)=>{y.dispatch(c.updateIllaMode(t)),y.dispatch($.updateAppInfoReducer(e.appInfo));const s=Y(e.components);y.dispatch(E.initComponentReducer(B(s)));const r=z(e.actions);y.dispatch(p.initActionListReducer(r)),I.initApp(o,i,n),I.updateDisplayNameList(e.components,r),y.dispatch(P.startExecutionReducer()),t==="edit"&&r.length>0&&y.dispatch(c.changeSelectedAction(r[0]))},me=e=>{const{appId:t=""}=X(),o=U(),i=D(T),n=D(j),[s,r]=S.useState(!0),[h,f]=S.useState(!1),u=e==="production"?"-2":"0",{uid:g,teamID:d}={uid:(n==null?void 0:n.uid)??"",teamID:(n==null?void 0:n.id)??""};Z();const m=S.useCallback(x=>{oe(x,e,t,d,g)},[e,t,d,g]);return S.useEffect(()=>{const x=new AbortController;return i&&(f(!1),r(!0),Promise.all([k(t,u,x.signal),H(x.signal)]).then(C=>{o(L.updateResourceListReducer(C[1].data)),m(C[0].data)}).catch(()=>{f(!0)}).finally(()=>{r(!1)})),()=>{x.abort(),o($.updateAppInfoReducer(W))}},[t,o,m,i,d,u]),{loadingState:s,errorState:h}},be=a`
  display: flex;
...
//# sourceMappingURL=style-51b259bb.js.map
