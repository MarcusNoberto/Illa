import{k as n,l as h,m as g,o as b,a3 as N,J as k,T as D,cv as I,aW as _,O as j}from"./@illa-design-1f43bb6c.js";import{r as a}from"./react-9b7e00e3.js";import{r as v}from"./style-a950892e.js";import{gX as E,u as S,en as L}from"./index-4dce6ee8.js";import{b as V,a as O,g as z}from"./generateNewColumns-642a5112.js";import{a as i}from"./@emotion-08a6282b.js";import{i as w}from"./lodash-lib-6e94956b.js";import"./codeMirror-vendor-320207e2.js";import"./react-icons-vendor-2430ea65.js";const C=a.createContext({}),$=r=>{const{columnItems:t,attrPath:o,handleUpdateDsl:e}=r,c=a.useCallback(l=>{const s=t.filter((y,p)=>p!==l);e(o,s)},[t,e,o]),u=a.useCallback(l=>{let s=t.find((p,x)=>x===l);if(!s)return;s={...s,id:V()};const y=[...t,s];e(o,y)},[t,e,o]),d=a.useCallback((l,s)=>{const y=t[l],p=[...t];p.splice(l,1),p.splice(s,0,y),e(o,p)},[o,t,e]),m=a.useCallback((l,s)=>{e(l,s)},[e]),f={...r,handleDeleteColumnItem:c,handleCopyColumnItem:u,handleMoveColumnItem:d,handleUpdateItemVisible:m};return n(C.Provider,{value:f,children:r.children})};$.displayName="ColumnsSetterProvider";i`
  width: 100%;
